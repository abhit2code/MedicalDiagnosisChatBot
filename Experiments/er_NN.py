...
y_valid_predictions, scores = make_classification_predictions(classification_model, X_valid)




with open("nn_disease_classification.csv", 'w', newline='') as file:
    writer = csv.writer(file, delimiter=',')
    for i in range(len(y_valid_predictions)):
        writer.writerow([y_valid_predictions[i], y_valid[i], scores[i]])